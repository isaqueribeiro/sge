...
/*------ SYSDBA 31/10/2016 16:10:39 --------*/

CREATE INDEX IDX_TBEMPRESA_FANTASIA
ON TBEMPRESA (NMFANT);

CREATE INDEX IDX_TBEMPRESA_RAZAO
ON TBEMPRESA (RZSOC);




/*------ SYSDBA 21/11/2016 18:37:23 --------*/

ALTER TABLE TBCONFIGURACAO
    ADD VENDA_FORMA_PAGTO_CARTACREDITO DMN_SMALLINT_N;

COMMENT ON COLUMN TBCONFIGURACAO.VENDA_FORMA_PAGTO_CARTACREDITO IS
'Venda: Codigo da forma de pagamento que corresponde a CARTA DE CREDITO.';
...
alter table TBCONFIGURACAO
alter CUSTO_OPER_CALCULAR position 12;

alter table TBCONFIGURACAO
alter PERMITIR_VENDA_ESTOQUE_INS position 13;

alter table TBCONFIGURACAO
alter VENDA_CARREGA_PRODUTO_EAN position 14;

alter table TBCONFIGURACAO
alter VENDA_FORMA_PAGTO_CARTACREDITO position 15;
...
alter table TBCONFIGURACAO
alter AUTORIZA_INFORMA_CLIENTE position 18;

alter table TBCONFIGURACAO
alter USUARIO position 19;

alter table TBCONFIGURACAO
alter NFE_EMITIR position 20;

alter table TBCONFIGURACAO
alter NFE_SERIE position 21;

alter table TBCONFIGURACAO
alter NFE_NUMERO position 22;

alter table TBCONFIGURACAO
alter NFE_EMITIR_ENTRADA position 23;

alter table TBCONFIGURACAO
alter NFE_ACEITAR_NOTA_DENEGADA position 24;

alter table TBCONFIGURACAO
alter NFE_SOLICITA_DH_SAIDA position 25;

alter table TBCONFIGURACAO
alter NFE_IMPRIMIR_COD_CLIENTE position 26;

alter table TBCONFIGURACAO
alter NFCE_EMITIR position 27;

alter table TBCONFIGURACAO
alter NFCE_SERIE position 28;

alter table TBCONFIGURACAO
alter NFCE_NUMERO position 29;

alter table TBCONFIGURACAO
alter NFCE_TOKEN_ID position 30;

alter table TBCONFIGURACAO
alter NFCE_TOKEN position 31;

alter table TBCONFIGURACAO
alter NFSE_EMITIR position 32;

alter table TBCONFIGURACAO
alter NFSE_SERIE position 33;

alter table TBCONFIGURACAO
alter NFSE_NUMERO position 34;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_PIS position 35;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_COFINS position 36;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_CSLL position 37;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_ISSQN position 38;




/*------ SYSDBA 21/11/2016 18:38:47 --------*/

ALTER TABLE TBCONFIGURACAO DROP CONSTRAINT FK_TBCONFIGURACAO_FPG_CARTACRED;

ALTER TABLE TBCONFIGURACAO
ADD CONSTRAINT FK_TBCONFIGURACAO_FPG_CARTACRED
FOREIGN KEY (VENDA_FORMA_PAGTO_CARTACREDITO)
REFERENCES TBFORMPAGTO(COD)
USING INDEX FK_TBCONFIGURACAO_FPG_CARTACRED;




/*------ SYSDBA 22/11/2016 11:54:28 --------*/

update RDB$RELATION_FIELDS set
RDB$FIELD_SOURCE = 'DMN_LOGICO'
where (RDB$FIELD_NAME = 'NFE_ACEITAR_NOTA_DENEGADA') and
(RDB$RELATION_NAME = 'TBCONFIGURACAO')
;



/*------ SYSDBA 22/11/2016 11:58:57 --------*/

Update TBCONFIGURACAO Set
  NFE_ACEITAR_NOTA_DENEGADA = 0
where NFE_ACEITAR_NOTA_DENEGADA is null;

/*------ SYSDBA 22/11/2016 11:59:00 --------*/

COMMIT WORK;

/*------ SYSDBA 22/11/2016 12:00:09 --------*/

Update TBCONFIGURACAO Set
  NFE_ACEITAR_NOTA_DENEGADA = 0
where NFE_ACEITAR_NOTA_DENEGADA is null;

/*------ SYSDBA 22/11/2016 12:00:12 --------*/

COMMIT WORK;


/*------ SYSDBA 29/11/2016 10:53:24 --------*/

COMMENT ON COLUMN TBCONFIGURACAO.PERMITIR_VENDA_ESTOQUE_INS IS
'Venda: Permitir vendas de produtos com estoque insuficiente e/ou zerado:
0 - Nao
1 - Sim';
...
/*------ SYSDBA 29/11/2016 11:24:02 --------*/

ALTER TABLE TBCONFIGURACAO
    ADD CLIENTE_PERMITIR_VF_CNPJ DMN_LOGICO DEFAULT 0;

COMMENT ON COLUMN TBCONFIGURACAO.CLIENTE_PERMITIR_VF_CNPJ IS
'Cliente: Permitir Verdadeiro-Falso na validacao do CPF/CNPJ no Cadastro:
0 - Nao
1 - Sim';
...
alter table TBCONFIGURACAO
alter NFSE_SERIE position 34;

alter table TBCONFIGURACAO
alter NFSE_NUMERO position 35;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_PIS position 36;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_COFINS position 37;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_CSLL position 38;

alter table TBCONFIGURACAO
alter NFSE_PERCENTUAL_ISSQN position 39;




/*------ SYSDBA 29/11/2016 13:20:48 --------*/
