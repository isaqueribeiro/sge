...
const
  ...
  REJEICAO_NFE_CFOP_DIFERENTE = 733; // Rejeição: CFOP de operação interna e idDest diferente de 1
...
//                end;
            ...
            begin
              ...
              //  - Agrotóxicos e pesticidas : NCM 3808.
              //  - Combustíveis fósseis : NCM 2710 (óleos de petróleo).
              ...
              if MatchStr(Prod.CFOP, ['5910', '6910']) then // Remessa em bonificação, doação ou brinde (5 - Dentro do Estado, 6 - Fora do Estado)
                IBSCBS.indDoacao := TIndicadorEx.tieSim
              else
                IBSCBS.indDoacao := TIndicadorEx.tieNao;

              // gIBSCBS - Grupo de Informações do IBS para a UF
              if (IBSCBS.CST in [
                TCSTIBSCBS.cst000,
                TCSTIBSCBS.cst200,
                TCSTIBSCBS.cst220,
              ...
              begin
                ...
                // Divisão do IBS entre a UF e Município
                ...
                begin
                  ...
                  cAliquotaIBSUF := IBSCBS.gIBSCBS.gIBSUF.gRed.pAliqEfet / 2;    // Divisão do IBS entre para a UF
                ...
                begin
                  // Diferimento na UF
                  IBSCBS.gIBSCBS.gIBSUF.gDif.pDif := 0.0; // A DEFINIR FUTURAMENTE QUANDO NECESSÁRIO.
...
//              ) then
              if ((aStatusNFe = REJEICAO_NFE_CFOP_INVALIDO) or (aStatusNFe = REJEICAO_NFE_CFOP_DIFERENTE)) then
                sErrorMsg :=
                  'Código Fiscal de Operação não adequado para este tipo de movimento dos produtos. ' +
                  'Favor corrija-o clicando com o botão direito do mouse no campo CFOP' + #13#13 +
                  'Após este procedimento, gere novamente a NFC-e';
            end;
