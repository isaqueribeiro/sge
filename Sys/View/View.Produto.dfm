inherited ViewProduto: TViewProduto
      ...
      object pgcMaisDados: TPageControl
        ...
        object tbsTributacao: TTabSheet
          ...
          object GrpBxDadosTributoICMS: TGroupBox
            ...
            object lblCST2026: TLabel
              Left = 16
              Top = 104
              Width = 195
              Height = 13
              Caption = 'CST/IBS (C'#243'digo de Situa'#231#227'o Tribut'#225'ria):'
              FocusControl = dbCST2026
            end
            object lblCCT2026: TLabel
              Left = 261
              Top = 104
              Width = 165
              Height = 13
              Caption = 'C'#243'digo de Classifica'#231#227'o Tribut'#225'ria:'
              FocusControl = dbCCT2026
            end
            ...
            object dbCST2026: TDBLookupComboBox
              Left = 16
              Top = 120
              Width = 239
              Height = 21
              ...
              ListSource = dtsTributacaoIBS_CBS
              ParentFont = False
              TabOrder = 11
            end
            object dbCCT2026: TJvDBComboEdit
              Left = 261
              Top = 120
              Width = 404
              Height = 21
              ButtonHint = 'Pesquisar Classe Tribut'#225'ria (Ctrl+P)'
              CharCase = ecUpperCase
              ClickKey = 16464
              Color = clMoneyGreen
              DataField = 'CCT2026_DESCRICAO'
              DataSource = DtSrcTabela
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Height = -11
              ...
              ShowHint = True
              TabOrder = 12
              OnButtonClick = dbCCT2026ButtonClick
            end
          end
          object GrpBxDadosTributoPIS: TGroupBox
            ...
            object lblCTSIS: TLabel
              Left = 16
              Top = 64
              Width = 283
              Height = 13
              Caption = 'CST/IS (C'#243'digo de Situa'#231#227'o Tribut'#225'ria do Imposto Seletivo)'
              FocusControl = dbCTSIS
            end
            ...
            object lblAliquotaCBS: TLabel
              Left = 474
              Top = 64
              Width = 37
              Height = 13
              Caption = '% CBS:'
              FocusControl = dbAliquotaCBS
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -11
              Font.Name = 'Tahoma'
            ...
            object dbCTSIS: TJvDBComboEdit
              Left = 16
              Top = 80
              Width = 389
              Height = 21
              ButtonHint = 'Pesquisar CST/IS (Ctrl+P)'
              CharCase = ecUpperCase
              ClickKey = 16464
              Color = clMoneyGreen
              DataField = 'CTSIS_DESCRICAO'
              DataSource = DtSrcTabela
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Height = -11
              ...
              ShowHint = True
              TabOrder = 4
              OnButtonClick = dbCTSISButtonClick
            end
  ...
  object dtsTributacaoIBS_CBS: TDataSource
    Left = 536
  end
end
