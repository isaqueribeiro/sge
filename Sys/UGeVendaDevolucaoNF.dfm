inherited frmGeVendaDevolucaoNF: TfrmGeVendaDevolucaoNF
  ...
  object updVenda: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  DNFE_COMPRA_ANO = :DNFE_COMPRA_ANO,'
      '  DNFE_COMPRA_COD = :DNFE_COMPRA_COD,'
