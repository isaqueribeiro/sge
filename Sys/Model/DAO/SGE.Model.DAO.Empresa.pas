  ...
  FConn
    .Query
      .SQL
        ...
        .Add('  , coalesce(s.custo_oper_calcular, 0)        as custo_oper_calcular ')
        .Add('  , coalesce(s.estoque_unico_empresas, 0)     as estoque_unico ')
        .Add('  , coalesce(s.estoque_satelite_cliente, 0)   as estoque_satelite_cliente ')
        .Add('  , coalesce(s.permitir_venda_estoque_ins, 0) as permitir_venda_estoque_ins')
        .Add('  , coalesce(s.cliente_permitir_duplicar_cnpj, 0) as cliente_permitir_duplicar_cnpj')
        .Add('  , coalesce(s.cliente_permitir_vf_cnpj, 0)       as cliente_permitir_vf_cnpj')
