inherited frmGeOSFormaPagto: TfrmGeOSFormaPagto
  Left = 831
  Top = 242
  ...
  object GrpBxControle: TGroupBox
    ...
    object dbCodigo: TDBEdit
      ...
      Color = clMoneyGreen
      DataField = 'CONTROLE'
      DataSource = frmGeOS.DtSrcTabela
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object GrpBxFormaPagto: TGroupBox
    ...
    object dbPrazo01: TDBEdit
      ...
      Color = clMoneyGreen
      DataField = 'PRAZO_01'
      DataSource = frmGeOS.dtsOSFormaPagto
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object dbFormaPagto: TDBLookupComboBox
      ...
      KeyField = 'COD'
      ListField = 'DESCRI'
      ListSource = frmGeOS.dtsFormaPagto
      ParentFont = False
      TabOrder = 0
    end
    object dbCondicaoPagto: TDBLookupComboBox
      ...
      ListSource = frmGeOS.dtsCondicaoPagto
      ParentFont = False
      TabOrder = 1
