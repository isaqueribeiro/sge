inherited frmGePromocao: TfrmGePromocao
  ...
  inherited pgcGuias: TPageControl
    ...
    inherited tbsCadastro: TTabSheet
      ...
      inherited GrpBxDadosNominais: TGroupBox
        ...
        object dbDataFinal: TJvDBDateEdit [5]
          Left = 624
          Top = 40
          Width = 105
          Height = 21
        ...
        object dbDataInicio: TJvDBDateEdit
          Left = 512
          Top = 40
          Width = 105
          Height = 21
      ...
      object GrpBxDadosProduto: TGroupBox
        ...
        object dbValorPromocao: TJvDBComboEdit
          Left = 280
          Top = 80
          Width = 105
          Height = 21
  ...
  inherited fdQryTabela: TFDQuery
    ...
    object fdQryTabelaDATA_INICIO: TDateField
    ...
    object fdQryTabelaDATA_FINAL: TDateField
  ...
  inherited fdUpdTabela: TFDUpdateSQL
    InsertSQL.Strings = (
      'INSERT INTO TBPROMOCAO'
      '(CODIGO, DESCRICAO, DATA_INICIO, DATA_FINAL, '
      '  PERCENTUAL_DESCONTO, ATIVA)'
      
        'VALUES (:NEW_CODIGO, :NEW_DESCRICAO, :NEW_DATA_INICIO, :NEW_DATA' +
        '_FINAL, '
      '  :NEW_PERCENTUAL_DESCONTO, :NEW_ATIVA)'
      'RETURNING CODIGO, PERCENTUAL_DESCONTO, ATIVA')
    ModifySQL.Strings = (
      'UPDATE TBPROMOCAO'
      
        'SET CODIGO = :NEW_CODIGO, DESCRICAO = :NEW_DESCRICAO, DATA_INICI' +
        'O = :NEW_DATA_INICIO, '
      
        '  DATA_FINAL = :NEW_DATA_FINAL, PERCENTUAL_DESCONTO = :NEW_PERCE' +
        'NTUAL_DESCONTO, '
      '  ATIVA = :NEW_ATIVA'
    ...
    FetchRowSQL.Strings = (
        ...
        'SELECT CODIGO, DESCRICAO, DATA_INICIO, DATA_FINAL, PERCENTUAL_DE' +
        'SCONTO, '
      '  ATIVA'
      'FROM TBPROMOCAO'
      'WHERE CODIGO = :CODIGO')
  ...
  object qryProduto: TFDQuery
    ...
    object qryProdutoPESSOA_FISICA: TSmallintField
      FieldName = 'PESSOA_FISICA'
      Origin = 'PESSOA_FISICA'
      Required = True
    end
    object qryProdutoCNPJ: TStringField
      FieldName = 'CNPJ'
      Origin = 'CNPJ'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object qryProdutoRZSOC: TStringField
      FieldName = 'RZSOC'
      Origin = 'RZSOC'
      Size = 60
    end
    object qryProdutoNMFANT: TStringField
      FieldName = 'NMFANT'
      Origin = 'NMFANT'
      Size = 25
    end
    object qryProdutoIE: TStringField
      FieldName = 'IE'
      Origin = 'IE'
      Size = 11
    end
    object qryProdutoIM: TStringField
      FieldName = 'IM'
      Origin = 'IM'
      Size = 12
    end
    object qryProdutoCNAE: TStringField
      FieldName = 'CNAE'
      Origin = 'CNAE'
      Size = 11
    end
    object qryProdutoFONE: TStringField
      FieldName = 'FONE'
      Origin = 'FONE'
      Size = 11
    end
    object qryProdutoLOGO: TBlobField
      FieldName = 'LOGO'
      Origin = 'LOGO'
    end
    object qryProdutoTLG_TIPO: TSmallintField
      FieldName = 'TLG_TIPO'
      Origin = 'TLG_TIPO'
    end
    object qryProdutoTLG_DESCRICAO: TStringField
    ...
    object qryProdutoTLG_SIGLA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'TLG_SIGLA'
      Origin = 'TLG_SIGLA'
      ProviderFlags = []
    ...
    object qryProdutoLOG_COD: TIntegerField
      FieldName = 'LOG_COD'
      Origin = 'LOG_COD'
    end
    object qryProdutoLOG_NOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOG_NOME'
      Origin = 'LOG_NOME'
      ProviderFlags = []
    ...
    object qryProdutoCOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Origin = 'COMPLEMENTO'
      Size = 50
    end
    object qryProdutoNUMERO_END: TStringField
      FieldName = 'NUMERO_END'
      Origin = 'NUMERO_END'
      Size = 10
    end
    object qryProdutoCEP: TStringField
      FieldName = 'CEP'
      Origin = 'CEP'
      Size = 8
    end
    object qryProdutoBAI_COD: TIntegerField
      FieldName = 'BAI_COD'
      Origin = 'BAI_COD'
    end
    object qryProdutoBAI_NOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'BAI_NOME'
      Origin = 'BAI_NOME'
      ProviderFlags = []
    ...
    object qryProdutoCID_COD: TIntegerField
      FieldName = 'CID_COD'
      Origin = 'CID_COD'
    end
    object qryProdutoCID_NOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CID_NOME'
      Origin = 'CID_NOME'
      ProviderFlags = []
    ...
    object qryProdutoCID_SIAFI: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'CID_SIAFI'
      Origin = 'CID_SIAFI'
      ProviderFlags = []
    ...
    object qryProdutoCID_IBGE: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'CID_IBGE'
      Origin = 'CID_IBGE'
      ProviderFlags = []
    ...
    object qryProdutoCID_DDD: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'CID_DDD'
      Origin = 'CID_DDD'
      ProviderFlags = []
    ...
    object qryProdutoEST_COD: TSmallintField
      FieldName = 'EST_COD'
      Origin = 'EST_COD'
    end
    object qryProdutoEST_NOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'EST_NOME'
      Origin = 'EST_NOME'
      ProviderFlags = []
    ...
    object qryProdutoEST_SIGLA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'EST_SIGLA'
      Origin = 'EST_SIGLA'
      ProviderFlags = []
    ...
    object qryProdutoEST_SIAFI: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'EST_SIAFI'
      Origin = 'EST_SIAFI'
      ProviderFlags = []
    ...
    object qryProdutoEMAIL: TStringField
      FieldName = 'EMAIL'
      Origin = 'EMAIL'
      Size = 100
    end
    object qryProdutoHOME_PAGE: TStringField
      FieldName = 'HOME_PAGE'
      Origin = 'HOME_PAGE'
      Size = 100
    end
    object qryProdutoCHAVE_ACESSO_NFE: TStringField
      FieldName = 'CHAVE_ACESSO_NFE'
      Origin = 'CHAVE_ACESSO_NFE'
      Size = 250
    end
    object qryProdutoTIPO_REGIME_NFE: TSmallintField
      FieldName = 'TIPO_REGIME_NFE'
      Origin = 'TIPO_REGIME_NFE'
    end
    object qryProdutoSERIE_NFE: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'SERIE_NFE'
      Origin = 'SERIE_NFE'
      ProviderFlags = []
    ...
    object qryProdutoNUMERO_NFE: TIntegerField
      AutoGenerateValue = arDefault
    ...
    object qryProdutoLOTE_ANO_NFE: TSmallintField
      AutoGenerateValue = arDefault
    ...
    object qryProdutoLOTE_NUM_NFE: TIntegerField
      AutoGenerateValue = arDefault
    ...
    object qryProdutoPAIS_ID: TStringField
      FieldName = 'PAIS_ID'
      Origin = 'PAIS_ID'
      Size = 5
    end
    object qryProdutoSERIE_NFCE: TSmallintField
      AutoGenerateValue = arDefault
    ...
    object qryProdutoNUMERO_NFCE: TIntegerField
      AutoGenerateValue = arDefault
    ...
    object qryProdutoPAIS_NOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PAIS_NOME'
      Origin = 'PAIS_NOME'
      ProviderFlags = []
    ...
    object qryProdutoRECONFIGURAR: TIntegerField
      AutoGenerateValue = arDefault
  ...
  object cdsProdutos: TFDQuery
    ...
    object cdsProdutosUSUARIO: TStringField
      FieldName = 'USUARIO'
      Origin = 'USUARIO'
      Size = 50
    end
  ...
  object IbUpdProdutos: TFDUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '(CODIGO_PROM, CODIGO_PROD, PRECO_VENDA, PRECO_PROMOCAO, '
      '  DESCONTO, USUARIO)'
      
        'VALUES (:NEW_CODIGO_PROM, :NEW_CODIGO_PROD, :NEW_PRECO_VENDA, :N' +
        'EW_PRECO_PROMOCAO, '
      '  :NEW_DESCONTO, :NEW_USUARIO)'
      'RETURNING PRECO_VENDA, PRECO_PROMOCAO, DESCONTO, USUARIO')
    ModifySQL.Strings = (
      'UPDATE TBPROMOCAO_PRODUTO'
      
        'SET CODIGO_PROM = :NEW_CODIGO_PROM, CODIGO_PROD = :NEW_CODIGO_PR' +
        'OD, '
      
        '  PRECO_VENDA = :NEW_PRECO_VENDA, PRECO_PROMOCAO = :NEW_PRECO_PR' +
        'OMOCAO, '
      '  DESCONTO = :NEW_DESCONTO, USUARIO = :NEW_USUARIO'
      
        'WHERE CODIGO_PROM = :OLD_CODIGO_PROM AND CODIGO_PROD = :OLD_CODI' +
        'GO_PROD'
      'RETURNING PRECO_VENDA, PRECO_PROMOCAO, DESCONTO, USUARIO')
    DeleteSQL.Strings = (
    ...
    FetchRowSQL.Strings = (
      ...
      'from TBPROMOCAO_PRODUTO p'
      '  inner join TBPRODUTO pr on (pr.Cod = p.Codigo_prod)'
      'WHERE p.CODIGO_PROM = :CODIGO_PROM'
      '   AND p.CODIGO_PROD = :CODIGO_PROD')
    Left = 672
    Top = 253
  end
end
