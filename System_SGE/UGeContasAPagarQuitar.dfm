inherited frmGeContasAPagarQuitar: TfrmGeContasAPagarQuitar
  ...
  inherited fdQryPesquisa: TFDQuery
    ...
    object fdQryPesquisaVALORPAG: TFMTBCDField
      FieldName = 'VALORPAG'
      Origin = 'VALORPAG'
      Precision = 18
      Size = 2
    end
    object fdQryPesquisaVALORMULTA: TFMTBCDField
      FieldName = 'VALORMULTA'
      Origin = 'VALORMULTA'
      Precision = 18
      Size = 2
    end
    object fdQryPesquisaVALORPAGTOT: TFMTBCDField
      FieldName = 'VALORPAGTOT'
      Origin = 'VALORPAGTOT'
      Precision = 18
      Size = 2
    end
    object fdQryPesquisaVALORSALDO: TFMTBCDField
      FieldName = 'VALORSALDO'
      Origin = 'VALORSALDO'
      Precision = 18
      Size = 2
    end
    object fdQryPesquisaVALOR_APAGAR: TFMTBCDField
      FieldName = 'VALOR_APAGAR'
      Origin = 'VALORSALDO'
      ProviderFlags = []
      Precision = 18
