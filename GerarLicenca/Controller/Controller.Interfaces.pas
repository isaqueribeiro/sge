...
type
  IControllerUsuario<T : class> = interface
    ...
    function CodeProject(Value : String) : IControllerUsuario<T>;
  ...
  IControllerCliente<T : class> = interface
    ...
    function CodeProject(Value : String) : IControllerCliente<T>;
    function Entity : TCliente<T>;
    function LoadDataSet(aTokenID : String; aClientDataSet : TClientDataSet) : IControllerCliente<T>;
    function Load(aTokenID, aDocument : String) : IControllerCliente<T>;
